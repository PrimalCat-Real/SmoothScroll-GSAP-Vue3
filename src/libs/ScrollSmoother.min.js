...
! function(e, t) {
    ...
    var I, z, N, W, B, F, U, Q, V, K, j, q, D, Y, X, i = "ScrollSmoother",
        a = "http://127.0.0.1:5173/",
        r = (function(e) {
            ...
            // console.log(r,"r");
            r = true;
            // n is hosting allow list
            // console.log(typeof n);
            // n.push("http://127.0.0.1:5173/")
            // console.log(n,"n");
            // console.log(o,"o");
            // console.log(a,"a");
            ...
            return z || (I = e || t(), s() && window.document && (N = window, W = document, B = W.documentElement, F = W.body), I && (U = I.utils.toArray, Q = I.utils.clamp, j = I.parseEase("expo"), Y = I.core.context || function() {}, X = I.delayedCall(.2, function() {
                return V.isRefreshing || K && K.refresh()
            }).pause(), V = I.core.globals().ScrollTrigger, I.core.globals("ScrollSmoother", ScrollSmoother), F && V && (q = V.core._getVelocityProp, D = V.core._inputObserver, ScrollSmoother.refresh = V.refresh, z = 1))), z
    ...
    function ScrollSmoother(e) {
        ...
        function Sa() {
            Ka(), requestAnimationFrame(Ka), v && (v.forEach(function(e) {
                var t = e.start,
        ...
        function Xa(r, e, t, n) {
                ...
                if (a) {
                    ...
                    var t = function _autoDistance(e, t) {
                        var r, n, o = e.parentNode || B,
                            ...
                            u = -c * t;
                        return 0 < c && (n = .5 == (r = s.height / (N.innerHeight + s.height)) ? 2 * s.height : 2 * Math.min(s.height, -c * r / (2 * r - 1)) * (t || 1), u += t ? -n * t : -n / 2, c += n), {
                            change: c,
                            offset: u
                        }
            ...
            var o, i, a, l, c, u, s = Wa("speed", e, n, r),
                f = Wa("lag", t, n, r),
                h = I.getProperty(r, "y"),
                d = r._gsap,
                g = [],
                p = [],
                w = 0;
            return Lb(), (1 !== o || a || l) && (Qb(i = V.create({
                ...
                onUpdate: function onUpdate(e) {
                    ...
                    if (e.offset) {
                        if (i) {
                            for (r = -P, n = e.end; i--;) {
                                if ((t = g[i]).trig.isActive || r >= t.start && r <= t.end) return void(l && (t.trig.progress += t.trig.direction < 0 ? .001 : -.001, t.trig.update(0, 0, 1), l.resetTo("y", parseFloat(d.y), -M, !0), O && l.progress(1)));
            ...
            })), I.core.getCache(i.trigger).stRevert = Va, i.startY = h, i.pins = g, i.markers = p, i.ratio = o, i.autoSpeed = a, r.style.willChange = "transform"), i
        }
        var n, m, t, i, v, s, a, l, c, u, r, f, h, d, g, p = e.smoothTouch,
            w = e.onUpdate,
            S = e.onStop,
            b = e.smooth,
            T = e.onFocusIn,
            x = e.normalizeScroll,
            E = this,
            R = "undefined" != typeof ResizeObserver && !1 !== e.autoResize && new ResizeObserver(function() {
                return V.isRefreshing || X.restart(!0)
            }),
            k = e.effectsPrefix || "",
            _ = V.getScrollFunc(N),
            C = 1 === V.isTouch ? !0 === p ? .8 : parseFloat(p) || 0 : 0 === b || !1 === b ? 0 : parseFloat(b) || .8,
            P = 0,
            M = 0,
            O = 1,
            A = q(0),
        ...
        Ta(), V.addEventListener("killAll", Ta), I.delayedCall(.5, function() {
            return O = 0
        }), this.scrollTop = Oa, this.scrollTo = function(e, t, r) {
            ...
            }(n), l = m.getAttribute("style") || "", refreshHeight(), I.set(m, C ? {
                overflow: "hidden",
                position: "fixed",
                height: "100%",
                width: "100%",
        ...
        L.forEach(function(e) {
            ...
            onRefreshInit: function onRefreshInit(e) {
                ...
                var r = e.getTween();
                h = r && r._end > r._dp._time, f = P, H.y = 0, C && (m.style.pointerEvents = "none", m.scrollTop = 0, setTimeout(function() {
                    return m.style.removeProperty("pointer-events")
                }, 50))
            },
            onRefresh: function onRefresh(e) {
                e.animation.invalidate(), e.setPositions(e.start, refreshHeight()), h || Ma(e), H.y = -_(), Na(H.y), O || e.animation.progress(I.utils.clamp(0, 1, f / -e.end)), h && (e.progress -= .001, e.update())
            },
            id: "ScrollSmoother",
            scroller: N,
        ...
        }, i.getTween() && (i.getTween().vars.ease = e.ease || j), this.scrollTrigger = i, e.effects && this.effects(!0 === e.effects ? "[data-" + k + "speed], [data-" + k + "lag]" : e.effects, {}), e.sections && this.sections(!0 === e.sections ? "[data-section]" : e.sections), L.forEach(function(e) {
            e.vars.scroller = m, e.init(e.vars, e.animation)
        }), this.paused = function(e, t) {
            return arguments.length ? (!!u !== e && (e ? (i.getTween() && i.getTween().pause(), _(-P), A.reset(), (r = V.normalizeScroll()) && r.disable(), (u = V.observe({
                preventDefault: !0,
            ...
            })).nested = D(B, "wheel,touch,scroll", !0, !1 !== t)) : (u.nested.kill(), u.kill(), u = 0, r && r.enable(), i.progress = (-P - i.start) / (i.end - i.start), Ma(i))), this) : !!u
            ...
            debounce: !0,
            content: !C && n
        } : x)), V.config(e), "overscrollBehavior" in N.getComputedStyle(F) && I.set([F, B], {
            overscrollBehavior: "none"
        }), "scrollBehavior" in N.getComputedStyle(F) && I.set([F, B], {
            scrollBehavior: "auto"
        }), N.addEventListener("focusin", Qa), a = setInterval(Ia, 250), "loading" === W.readyState || requestAnimationFrame(function() {
            return V.refresh()
        })
    }
